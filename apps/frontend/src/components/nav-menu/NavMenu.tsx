...
const NavMenuItems = () => {
    ...
    return (
        <Paper>
            <Collapse in={open} orientation="horizontal" collapsedSize={60} sx={collapseStyles}>
                <List>
                ...
                <Tooltip title={<TooltipContent/>}>
                    <ListItemText sx={{ml: '8px', flex: 1, cursor: 'pointer'}}>v{packageJson.version}</ListItemText>
                </Tooltip>
            </Collapse>
        </Paper>
    );
